...
abstract class AbstractByteBufTest_Purified {
    ...
    @Test
    void testSliceIndex_6() {
        assertThat(buffer.slice(0, buffer.capacity() - 1).writerIndex()).isEqualTo(buffer.capacity() - 1);
    }

    @Test
    void testSliceIndex_7() {
        assertThat(buffer.slice(1, buffer.capacity() - 1).writerIndex()).isEqualTo(buffer.capacity() - 1);
    }

    @Test
    void testSliceIndex_8() {
        assertThat(buffer.slice(1, buffer.capacity() - 2).writerIndex()).isEqualTo(buffer.capacity() - 2);
    }
}
