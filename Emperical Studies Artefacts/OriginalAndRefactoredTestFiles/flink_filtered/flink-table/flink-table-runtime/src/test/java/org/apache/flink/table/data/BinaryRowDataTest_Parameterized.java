...
class BinaryRowDataTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testHeaderSize_1to4")
    void testHeaderSize_1to4(int param1, int param2) {
        assertThat(BinaryRowData.calculateBitSetWidthInBytes(param2)).isEqualTo(param1);
    }

    static public Stream<Arguments> Provider_testHeaderSize_1to4() {
        return Stream.of(arguments(8, 56), arguments(16, 57), arguments(16, 120), arguments(24, 121));
    }
}
