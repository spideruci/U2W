...
class WatermarkAssignerOperatorTest_Parameterized extends WatermarkAssignerOperatorTestBase {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testCalculateProcessingTimeTimerInterval_1_3_5to10")
    void testCalculateProcessingTimeTimerInterval_1_3_5to10(int param1, int param2, int param3) {
        assertThat(calculateProcessingTimeTimerInterval(param2, param3)).isEqualTo(param1);
    }

    static public Stream<Arguments> Provider_testCalculateProcessingTimeTimerInterval_1_3_5to10() {
        return Stream.of(arguments(5, 5, 0), arguments(5, 0, 5), arguments(5, 5, 42), arguments(5, 42, 5), arguments(1, 2, 4), arguments(1, 4, 2), arguments(20, 100, 110), arguments(20, 110, 100));
    }
}
