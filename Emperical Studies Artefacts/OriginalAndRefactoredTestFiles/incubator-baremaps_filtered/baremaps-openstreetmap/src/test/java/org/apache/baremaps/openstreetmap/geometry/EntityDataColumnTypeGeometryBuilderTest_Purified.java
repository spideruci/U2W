...
class EntityDataColumnTypeGeometryBuilderTest_Purified {
    ...
    static final Map<Long, Coordinate> COORDINATE_CACHE = new HashMap<>(Arrays.asList(NODE_0, NODE_1, NODE_2, NODE_3, NODE_4, NODE_5, NODE_6, NODE_7, NODE_8, NODE_9, NODE_10, NODE_11, NODE_12, NODE_13, NODE_14, NODE_15).stream().collect(Collectors.toMap(n -> n.getId(), n -> new Coordinate(n.getLon(), n.getLat()))));
    ...
    static final Way WAY_2 = new Way(2L, INFO, ImmutableMap.of(), ImmutableList.of(0L, 1L, 2L, 3L, 0L));

    static final Way WAY_3 = new Way(3L, INFO, ImmutableMap.of(), ImmutableList.of(8L, 9L, 10L, 11L, 8L));

    static final Way WAY_4 = new Way(4L, INFO, ImmutableMap.of(), ImmutableList.of(4L, 5L, 6L, 7L, 4L));

    static final Way WAY_5 = new Way(5L, INFO, ImmutableMap.of(), ImmutableList.of(12L, 13L, 14L, 15L, 12L));

    static final Map<Long, List<Long>> REFERENCE_CACHE = new HashMap<>(Arrays.asList(WAY_0, WAY_1, WAY_2, WAY_3, WAY_4, WAY_5).stream().collect(Collectors.toMap(w -> w.getId(), w -> w.getNodes())));

    static final Relation RELATION_0 = new Relation(0L, INFO, ImmutableMap.of(), List.of());

    static final Relation RELATION_1 = new Relation(1L, INFO, ImmutableMap.of("type", "multipolygon"), List.of());

    static final Relation RELATION_2 = new Relation(2L, INFO, ImmutableMap.of("type", "multipolygon"), List.of(new Member(2L, MemberType.WAY, "outer")));

    static final Relation RELATION_3 = new Relation(3L, INFO, ImmutableMap.of("type", "multipolygon"), Arrays.asList(new Member(2L, MemberType.WAY, "outer"), new Member(3L, MemberType.WAY, "inner")));

    static final Relation RELATION_4 = new Relation(4L, INFO, ImmutableMap.of("type", "multipolygon"), Arrays.asList(new Member(2L, MemberType.WAY, "outer"), new Member(3L, MemberType.WAY, "inner"), new Member(4L, MemberType.WAY, "outer")));

    static final Relation RELATION_5 = new Relation(5L, INFO, ImmutableMap.of("type", "multipolygon"), Arrays.asList(new Member(2L, MemberType.WAY, "outer"), new Member(4L, MemberType.WAY, "inner"), new Member(5L, MemberType.WAY, "inner")));

    static final EntityGeometryBuilder GEOMETRY_BUILDER = new EntityGeometryBuilder(COORDINATE_CACHE, REFERENCE_CACHE);

    @Test
    void handleNode_1_testMerged_1() {
    ...
    @Test
    void handleNode_3_testMerged_2() {
