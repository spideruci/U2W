...
class SelfValidationTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_subClassExample_1_1")
    void subClassExample_1_1(String param1) {
        assertThat(ConstraintViolations.format(validator.validate(new SubclassExample()))).containsExactlyInAnyOrder(FAILED_RESULT, FAILED_RESULT + param1);
    }

    static public Stream<Arguments> Provider_subClassExample_1_1() {
        return Stream.of(arguments("subclass"), arguments("subclass"));
    }
}
