...
public class ITestS3Select_Parameterized extends AbstractS3SelectTest {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testBackslashExpansion_1to5")
    public void testBackslashExpansion_1to5(String param1, String param2) throws Throwable {
        assertEquals(param1, expandBackslashChars(param2));
    }

    static public Stream<Arguments> Provider_testBackslashExpansion_1to5() {
        return Stream.of(arguments("\t\r\n", "\t\r\n"), arguments("\t", "\\t"), arguments("\r", "\\r"), arguments("\r \n", "\\r \\n"), arguments("\\", "\\\\"));
    }
}
