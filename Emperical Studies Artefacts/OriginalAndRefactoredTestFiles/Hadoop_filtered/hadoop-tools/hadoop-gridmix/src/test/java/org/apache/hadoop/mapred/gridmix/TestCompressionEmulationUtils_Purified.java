...
public class TestCompressionEmulationUtils_Purified {
    ...
    @Test
    public void testCompressionRatioStandardization_1() throws Exception {
        assertEquals(0.55F, CompressionEmulationUtil.standardizeCompressionRatio(0.55F), 0.0D);
    }

    @Test
    public void testCompressionRatioStandardization_2() throws Exception {
        assertEquals(0.65F, CompressionEmulationUtil.standardizeCompressionRatio(0.652F), 0.0D);
    }

    @Test
    public void testCompressionRatioStandardization_3() throws Exception {
        assertEquals(0.78F, CompressionEmulationUtil.standardizeCompressionRatio(0.777F), 0.0D);
    }

    @Test
    public void testCompressionRatioStandardization_4() throws Exception {
