...
public class TestValidateConfiguration_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testGetAccountNameFromFQDN_1to2")
    public void testGetAccountNameFromFQDN_1to2(String param1, String param2) {
        assertEquals(param1, AdlFileSystem.getAccountNameFromFQDN(param2));
    }

    static public Stream<Arguments> Provider_testGetAccountNameFromFQDN_1to2() {
        return Stream.of(arguments("dummy", "dummy.azuredatalakestore.net"), arguments("localhost", "localhost"));
    }
}
