...
public class TestMountTable_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testGetterSetter_3_3")
    public void testGetterSetter_3_3(int param1) throws IOException {
        assertTrue(DATE_CREATED > param1);
    }

    static public Stream<Arguments> Provider_testGetterSetter_3_3() {
        return Stream.of(arguments(0), arguments(0));
    }

    @ParameterizedTest
    @MethodSource("Provider_testGetterSetter_4_4")
    public void testGetterSetter_4_4(int param1) throws IOException {
        assertTrue(DATE_MOD > param1);
    }

    static public Stream<Arguments> Provider_testGetterSetter_4_4() {
        return Stream.of(arguments(0), arguments(0));
    }
}
