...
public class TestRouterTrash_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testIsTrashPath_7to10")
    public void testIsTrashPath_7to10(String param1) throws IOException {
        assertFalse(MountTableResolver.isTrashPath(param1));
    }

    static public Stream<Arguments> Provider_testIsTrashPath_7to10() {
        return Stream.of(arguments(""), arguments("/home/user/empty.Trash/Current"), arguments("/home/user/.Trash"), arguments("/.Trash/Current"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testSubtractTrashCurrentPath_6to9")
    public void testSubtractTrashCurrentPath_6to9(String param1, String param2) throws IOException {
        assertEquals(param1, MountTableResolver.subtractTrashCurrentPath(param2));
    }

    static public Stream<Arguments> Provider_testSubtractTrashCurrentPath_6to9() {
        return Stream.of(arguments("", ""), arguments("/home/user/empty.Trash/Current", "/home/user/empty.Trash/Current"), arguments("/home/user/.Trash", "/home/user/.Trash"), arguments("/.Trash/Current", "/.Trash/Current"));
    }
}
