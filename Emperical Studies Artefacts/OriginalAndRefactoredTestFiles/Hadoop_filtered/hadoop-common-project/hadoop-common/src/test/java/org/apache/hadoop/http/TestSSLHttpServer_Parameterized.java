...
public class TestSSLHttpServer_Parameterized extends HttpServerFunctionalTest {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testEcho_1to2")
    public void testEcho_1to2(String param1, String param2) throws Exception {
        assertEquals(param1, readFromURL(new URL(baseUrl, SERVLET_PATH_ECHO + param2)));
    }

    static public Stream<Arguments> Provider_testEcho_1to2() {
        return Stream.of(arguments("a:b\nc:d\n", "?a=b&c=d"), arguments("a:b\nc&lt;:d\ne:&gt;\n", "?a=b&c<=d&e=>"));
    }
}
