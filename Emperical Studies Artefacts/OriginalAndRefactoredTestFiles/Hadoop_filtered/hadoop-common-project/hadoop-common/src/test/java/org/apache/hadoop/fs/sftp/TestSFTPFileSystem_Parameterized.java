...
public class TestSFTPFileSystem_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testFileExists_2_6")
    public void testFileExists_2_6(int param1) throws Exception {
        assertThat(((SFTPFileSystem) sftpFs).getConnectionPool().getLiveConnCount()).isEqualTo(param1);
    }

    static public Stream<Arguments> Provider_testFileExists_2_6() {
