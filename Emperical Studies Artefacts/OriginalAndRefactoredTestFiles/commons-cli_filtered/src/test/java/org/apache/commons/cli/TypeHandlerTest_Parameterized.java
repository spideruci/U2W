...
public class TypeHandlerTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testCreateNumber_1to2")
    public void testCreateNumber_1to2(long param1, int param2) throws ParseException {
        assertEquals(param1, TypeHandler.createNumber(param2));
    }

    static public Stream<Arguments> Provider_testCreateNumber_1to2() {
        return Stream.of(arguments(0L, 0), arguments(0d, 0.0));
    }
}
