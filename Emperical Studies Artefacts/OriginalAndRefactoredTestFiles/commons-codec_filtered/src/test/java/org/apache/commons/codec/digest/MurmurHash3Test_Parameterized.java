...
public class MurmurHash3Test_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testHash32WithTrailingNegativeSignedBytesIsInvalid_1to2_4to6")
    public void testHash32WithTrailingNegativeSignedBytesIsInvalid_1to2_4to6(int param1, int param2, int param3, int param4, int param5) {
        assertNotEquals(-param1, MurmurHash3.hash32(new byte[] { -1 }, 0, 1, 0));
    }

    static public Stream<Arguments> Provider_testHash32WithTrailingNegativeSignedBytesIsInvalid_1to2_4to6() {
        return Stream.of(arguments(43192051, 0, 1, 0, "{'-1'}"), arguments(582037868, 0, 2, 0, "{'0', '-1'}"), arguments(1309567588, 0, 2, 0, "{'-1', '0'}"), arguments(363779670, 0, 3, 0, "{'-1', '0', '0'}"), arguments(225068062, 0, 3, 0, "{'0', '-1', '0'}"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testHash32x86WithTrailingNegativeSignedBytes_1to2_4to6")
    public void testHash32x86WithTrailingNegativeSignedBytes_1to2_4to6(int param1, int param2, int param3, int param4, int param5) {
        assertEquals(-param1, MurmurHash3.hash32x86(new byte[] { -1 }, 0, 1, 0));
    }

    static public Stream<Arguments> Provider_testHash32x86WithTrailingNegativeSignedBytes_1to2_4to6() {
        return Stream.of(arguments(43192051, 0, 1, 0, "{'-1'}"), arguments(582037868, 0, 2, 0, "{'0', '-1'}"), arguments(1309567588, 0, 2, 0, "{'-1', '0'}"), arguments(363779670, 0, 3, 0, "{'-1', '0', '0'}"), arguments(225068062, 0, 3, 0, "{'0', '-1', '0'}"));
    }
}
