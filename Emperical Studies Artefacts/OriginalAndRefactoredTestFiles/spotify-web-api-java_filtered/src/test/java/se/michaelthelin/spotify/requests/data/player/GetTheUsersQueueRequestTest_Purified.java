...
public class GetTheUsersQueueRequestTest_Purified extends AbstractDataTest<PlaybackQueue> {

    private final GetTheUsersQueueRequest defaultRequest = ITest.SPOTIFY_API.getTheUsersQueue().setHttpManager(TestUtil.MockedHttpManager.returningJson("requests/data/player/GetTheUsersQueueRequest.json")).build();

    public GetTheUsersQueueRequestTest() throws Exception {
        assertEquals("https://api.spotify.com:443/v1/me/player/queue", defaultRequest.getUri().toString());
    }
