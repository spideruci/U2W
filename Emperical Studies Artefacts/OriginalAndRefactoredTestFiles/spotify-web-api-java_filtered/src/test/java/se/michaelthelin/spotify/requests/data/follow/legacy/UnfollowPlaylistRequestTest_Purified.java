...
public class UnfollowPlaylistRequestTest_Purified extends AbstractDataTest<String> {
    ...
    private final UnfollowPlaylistRequest defaultRequest = ITest.SPOTIFY_API.unfollowPlaylist(ITest.ID_USER, ITest.ID_PLAYLIST).setHttpManager(TestUtil.MockedHttpManager.returningJson(null)).build();
