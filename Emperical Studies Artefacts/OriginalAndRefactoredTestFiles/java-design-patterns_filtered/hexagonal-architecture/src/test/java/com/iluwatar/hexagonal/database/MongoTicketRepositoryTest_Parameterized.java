...
@Disabled
class MongoTicketRepositoryTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testNextId_1to3")
    void testNextId_1to3(int param1) {
        assertEquals(param1, repository.getNextId());
    }

    static public Stream<Arguments> Provider_testNextId_1to3() {
