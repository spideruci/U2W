...
public class ExprEvalTest_Purified extends InitializedNullHandlingTest {
    ...
    @Test
    public void testLongSerde_1() {
        assertExpr(0, 1L);
    }

    @Test
    public void testLongSerde_2() {
        assertExpr(1234, 1L);
    }
