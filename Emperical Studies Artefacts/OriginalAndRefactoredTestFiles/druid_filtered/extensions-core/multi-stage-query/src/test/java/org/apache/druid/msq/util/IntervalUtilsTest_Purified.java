...
public class IntervalUtilsTest_Purified {
    ...
    @Test
    public void test_difference_3() {
        Assert.assertEquals(intervals("2000/2001"), IntervalUtils.difference(intervals("2000/2001"), intervals("2003/2004")));
    }

    @Test
    public void test_difference_4() {
        Assert.assertEquals(intervals("2000-01-02/2001"), IntervalUtils.difference(intervals("2000/2001"), intervals("2000/P1D")));
    }
    ...
    @Test
    public void test_doesIntervalMatchesGranularity_withStandardGranularities_11() {
        Assert.assertFalse(IntervalUtils.isAligned(Intervals.of("2000-01-01/2002-01-01"), Granularities.YEAR));
    }

    @Test
    public void test_doesIntervalMatchesGranularity_withStandardGranularities_12() {
        Assert.assertFalse(IntervalUtils.isAligned(Intervals.of("2000-01-01/2002-01-08"), Granularities.YEAR));
    }
