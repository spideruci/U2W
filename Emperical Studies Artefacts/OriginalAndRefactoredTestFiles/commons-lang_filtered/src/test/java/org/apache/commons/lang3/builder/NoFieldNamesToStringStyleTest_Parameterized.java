...
public class NoFieldNamesToStringStyleTest_Parameterized extends AbstractLangTest {
    ...
    static public Stream<Arguments> Provider_testAppendSuper_3to4() {
        return Stream.of(arguments("[hello]", "a", "hello", "Integer@8888[]"), arguments("[<null>,hello]", "a", "hello", "Integer@8888[<null>]"));
    }
