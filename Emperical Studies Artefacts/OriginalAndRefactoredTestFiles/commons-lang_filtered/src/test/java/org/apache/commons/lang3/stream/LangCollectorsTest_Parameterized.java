...
public class LangCollectorsTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testCollectStrings1Arg_1_1")
    public void testCollectStrings1Arg_1_1(String param1) {
        assertEquals(param1, join1());
    }

    static public Stream<Arguments> Provider_testCollectStrings1Arg_1_1() {
        return Stream.of(arguments(""), arguments(""));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings0Arg_1_1")
    public void testJoinCollectNonStrings0Arg_1_1(String param1) {
        assertEquals(param1, join0());
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings0Arg_1_1() {
        return Stream.of(arguments(""), arguments(""));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings0Arg_6to7")
    public void testJoinCollectNonStrings0Arg_6to7(int param1, int param2, int param3) {
        assertEquals(param1, join0(new AtomicLong(param2), new AtomicLong(param3)));
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings0Arg_6to7() {
        return Stream.of(arguments(12, 1, 2), arguments(12, 1, 2));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings1Arg_6to7")
    public void testJoinCollectNonStrings1Arg_6to7(String param1, int param2, int param3) {
        assertEquals(param1, join1(new AtomicLong(param2), new AtomicLong(param3)));
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings1Arg_6to7() {
        return Stream.of(arguments("1-2", 1, 2), arguments("1-2", 1, 2));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings3Args_1_1")
    public void testJoinCollectNonStrings3Args_1_1(String param1) {
        assertEquals(param1, join3());
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings3Args_1_1() {
        return Stream.of(arguments("<>"), arguments("<>"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings3Args_6to7")
    public void testJoinCollectNonStrings3Args_6to7(String param1, int param2, int param3) {
        assertEquals(param1, join3(new AtomicLong(param2), new AtomicLong(param3)));
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings3Args_6to7() {
        return Stream.of(arguments("<1-2>", 1, 2), arguments("<1-2>", 1, 2));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings4Args_1_1")
    public void testJoinCollectNonStrings4Args_1_1(String param1) {
        assertEquals(param1, join4());
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings4Args_1_1() {
        return Stream.of(arguments("<>"), arguments("<>"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoinCollectNonStrings4Args_7to8")
    public void testJoinCollectNonStrings4Args_7to8(String param1, int param2, int param3) {
        assertEquals(param1, join4(new AtomicLong(param2), new AtomicLong(param3)));
    }

    static public Stream<Arguments> Provider_testJoinCollectNonStrings4Args_7to8() {
        return Stream.of(arguments("<1-2>", 1, 2), arguments("<1-2>", 1, 2));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoiningNonStrings3Args_1_1")
    public void testJoiningNonStrings3Args_1_1(String param1) {
        assertEquals(param1, Stream.of().collect(JOINING_3));
    }

    static public Stream<Arguments> Provider_testJoiningNonStrings3Args_1_1() {
        return Stream.of(arguments("<>"), arguments("<>"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoiningNonStrings3Args_6to7")
    public void testJoiningNonStrings3Args_6to7(String param1, int param2, int param3) {
        assertEquals(param1, Stream.of(new AtomicLong(param2), new AtomicLong(param3)).collect(JOINING_3));
    }

    static public Stream<Arguments> Provider_testJoiningNonStrings3Args_6to7() {
        return Stream.of(arguments("<1-2>", 1, 2), arguments("<1-2>", 1, 2));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoiningNonStrings4Args_1_1")
    public void testJoiningNonStrings4Args_1_1(String param1) {
        assertEquals(param1, Stream.of().collect(JOINING_4));
    }

    static public Stream<Arguments> Provider_testJoiningNonStrings4Args_1_1() {
        return Stream.of(arguments("<>"), arguments("<>"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testJoiningNonStrings4Args_7to8")
    public void testJoiningNonStrings4Args_7to8(String param1, int param2, int param3) {
        assertEquals(param1, Stream.of(new AtomicLong(param2), new AtomicLong(param3)).collect(JOINING_4));
    }

    static public Stream<Arguments> Provider_testJoiningNonStrings4Args_7to8() {
        return Stream.of(arguments("<1-2>", 1, 2), arguments("<1-2>", 1, 2));
    }
}
