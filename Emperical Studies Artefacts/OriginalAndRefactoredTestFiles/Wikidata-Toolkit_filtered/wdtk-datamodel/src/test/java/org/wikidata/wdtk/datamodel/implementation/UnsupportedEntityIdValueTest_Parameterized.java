...
public class UnsupportedEntityIdValueTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testGetTypeString_1_1")
    public void testGetTypeString_1_1(String param1) {
        assertEquals(param1, firstValue.getEntityTypeJsonString());
    }

    static public Stream<Arguments> Provider_testGetTypeString_1_1() {
        return Stream.of(arguments("funky"), arguments("funky"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testGetTypeString_2_2")
    public void testGetTypeString_2_2(String param1) {
        assertEquals(param1, secondValue.getEntityTypeJsonString());
    }

    static public Stream<Arguments> Provider_testGetTypeString_2_2() {
        return Stream.of(arguments("shiny"), arguments("shiny"));
    }
}
