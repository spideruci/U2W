...
public class GenericUnpairedQuotesRuleTest_Purified {
    ...
    private void setUpRule(Language language) {
        ...
        GenericUnpairedQuotesRule rule = new GenericUnpairedQuotesRule(TestTools.getEnglishMessages(), Arrays.asList("»", "«", "\"", "'", "›", "‹"), Arrays.asList("«", "»", "\"", "'", "‹", "›"));
        lt.addRule(rule);
    }
