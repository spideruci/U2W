...
public class LookupExprMacroTest_Parameterized extends MacroTestBase {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testValidCalls_1to2")
    public void testValidCalls_1to2(int param1, String param2) {
        Assert.assertNotNull(apply(getArgs(Lists.newArrayList(param1, param2))));
    }

    static public Stream<Arguments> Provider_testValidCalls_1to2() {
        return Stream.of(arguments(1, "test_lookup"), arguments(null, "test_lookup"));
    }
}
