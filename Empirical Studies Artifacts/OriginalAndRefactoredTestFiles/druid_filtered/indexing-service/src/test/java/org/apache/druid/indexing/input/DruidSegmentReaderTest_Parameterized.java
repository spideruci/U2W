...
public class DruidSegmentReaderTest_Parameterized extends InitializedNullHandlingTest {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testReader_1_1_1_1_1")
    public void testReader_1_1_1_1_1(String param1, String param2, String param3, int param4, String param5, String param6, int param7, String param8, String param9, String param10, String param11, String param12, String param13, String param14, String param15, long param16, String param17, String param18, long param19, String param20, String param21, double param22, String param23, double param24, String param25, String param26, String param27, String param28, String param29, String param30, String param31, String param32) throws IOException {
        final DruidSegmentReader reader = new DruidSegmentReader(makeInputEntity(Intervals.of(param10)), indexIO, new TimestampSpec(param2, param3, DateTimes.of(param11)), new DimensionsSpec(ImmutableList.of(StringDimensionSchema.create(param14), new DoubleDimensionSchema(param15))), ColumnsFilter.all(), param1, temporaryFolder.newFolder());
        Assert.assertEquals(ImmutableList.of(new MapBasedInputRow(DateTimes.of(param4), ImmutableList.of(param5, param6), ImmutableMap.<String, Object>builder().put(param30, DateTimes.of(param32).getMillis()).put(param26, param27).put(param22, param23).put(param16, param17).put(param12, makeHLLC(param18)).build()), new MapBasedInputRow(DateTimes.of(param7), ImmutableList.of(param8, param9), ImmutableMap.<String, Object>builder().put(param31, DateTimes.of("2000T01").getMillis()).put(param28, param29).put(param24, param25).put(param19, param20).put(param13, makeHLLC(param21)).build())), readRows(reader));
    }

    static public Stream<Arguments> Provider_testReader_1_1_1_1_1() {
        return Stream.of(arguments("__time", "millis", "2000/P1D", 1971, "strCol", "dblCol", 2000, "strCol", "dblCol", "2000T01", "strCol", "dblCol", "met_s", "met_s", "cnt", 1L, "foo", "cnt", 1L, "bar", "dblCol", 1.23d, "dblCol", 4.56d, "strCol", "foo", "strCol", "bar", "__time", "__time", "2000T", "2000T01"), arguments("__time", "auto", "2000/P1D", 1971, "strCol", "dblCol", 2000, "strCol", "dblCol", "2000T01", "strCol", "dblCol", "met_s", "met_s", "cnt", 1L, "foo", "cnt", 1L, "bar", "dblCol", 1.23d, "dblCol", 4.56d, "strCol", "foo", "strCol", "bar", "__time", "__time", "2000T", "2000T01"), arguments("dblCol", "posix", "2000/P1D", 1971, "strCol", "dblCol", "dblCol", "strCol", "dblCol", "dblCol", "strCol", "dblCol", "met_s", "cnt", "cnt", 1L, 1L, "cnt", 1L, 1.23d, "dblCol", 4.56d, "strCol", "foo", "strCol", "bar", "__time", "bar", "__time", "__time", "2000T", "2000T01"), arguments("__time", "posix", "2000/P1D", "dblCol", "dblCol", "cnt", 1L, 1.23d, "dblCol", 4.56d, "strCol", "foo", "strCol", "bar", "__time", "__time"));
    }
}
