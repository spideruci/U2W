...
public class UnicodeBasedLangIdentifierTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testGetDominantLangCodes_1to5_23_27to31")
    public void testGetDominantLangCodes_1to5_23_27to31(String param1, String param2) {
        assertThat(codes(param1), is(param2));
    }

    static public Stream<Arguments> Provider_testGetDominantLangCodes_1to5_23_27to31() {
        return Stream.of(arguments("", "[]"), arguments(" ", "[]"), arguments("hallo", "[]"), arguments("hallo this is a text", "[]"), arguments("hallo this is a text стиль", "[]"), arguments("通常情况下 but here's more text with Latin characters", "[]"), arguments("ហើយដោយ​ព្រោះ​", "[km]"), arguments("லேங்குவேஜ்", "[ta]"), arguments("Το Linux μπορεί να εγκατασταθεί και", "[el]"), arguments("Δημιουργός του πυρήνα Linux είναι ο", "[el]"), arguments("Ο Τόρβαλντς ξεκίνησε", "[el]"));
    }
}
