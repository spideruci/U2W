...
public class TestNetUtils_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testGetHostNameOfIP_2to6")
    public void testGetHostNameOfIP_2to6(String param1) {
        assertNull(NetUtils.getHostNameOfIP(param1));
    }

    static public Stream<Arguments> Provider_testGetHostNameOfIP_2to6() {
        return Stream.of(arguments(""), arguments("crazytown"), arguments("127.0.0.1:"), arguments("127.0.0.1:-1"), arguments("127.0.0.1:A"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testGetHostNameOfIP_7to8")
    public void testGetHostNameOfIP_7to8(String param1) {
        assertNotNull(NetUtils.getHostNameOfIP(param1));
    }

    static public Stream<Arguments> Provider_testGetHostNameOfIP_7to8() {
        return Stream.of(arguments("127.0.0.1"), arguments("127.0.0.1:1"));
    }
}
