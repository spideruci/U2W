...
public class TestShutdownHookManager_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testShutdownRemove_2_7")
    public void testShutdownRemove_2_7(int param1) throws Throwable {
        assertEquals(param1, mgr.getShutdownHooksInOrder().size());
    }

    static public Stream<Arguments> Provider_testShutdownRemove_2_7() {
