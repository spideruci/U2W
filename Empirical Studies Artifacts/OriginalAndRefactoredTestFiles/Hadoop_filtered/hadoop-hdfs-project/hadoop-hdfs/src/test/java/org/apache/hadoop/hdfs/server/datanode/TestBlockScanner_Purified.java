...
public class TestBlockScanner_Purified {
    ...
    @Test(timeout = 120000)
    public void testCalculateNeededBytesPerSec_1() throws Exception {
    ...
    @Test(timeout = 120000)
    public void testCalculateNeededBytesPerSec_3() throws Exception {
        Assert.assertTrue(VolumeScanner.calculateShouldScan("test", 1, 3540, 0, 60));
    }

    @Test(timeout = 120000)
    public void testCalculateNeededBytesPerSec_4() throws Exception {
