...
public class TestDynamicInputFormat_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testGetSplitRatio_1to4")
    public void testGetSplitRatio_1to4(int param1, int param2, int param3) throws Exception {
        Assert.assertEquals(param1, DynamicInputFormat.getSplitRatio(param2, param3));
    }

    static public Stream<Arguments> Provider_testGetSplitRatio_1to4() {
        return Stream.of(arguments(1, 1, 1000000000), arguments(2, 11000000, 10), arguments(4, 30, 700), arguments(2, 30, 200));
    }
}
