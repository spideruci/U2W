...
class TestUnitsConversionUtil_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testUnitsConversion_15to16")
    void testUnitsConversion_15to16(int param1, String param2, String param3, String param4, int param5) {
        assertEquals(param1, UnitsConversionUtil.convert(param3, param4, param5), param2);
    }

    static public Stream<Arguments> Provider_testUnitsConversion_15to16() {
        return Stream.of(arguments(1073741, "Mi to k test failed", "Mi", "k", 1024), arguments(953, "M to Mi test failed", "M", "Mi", 1000));
    }
}
