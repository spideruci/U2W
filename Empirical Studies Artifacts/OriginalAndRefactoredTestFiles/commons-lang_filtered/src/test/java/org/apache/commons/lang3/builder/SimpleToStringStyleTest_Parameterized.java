...
public class SimpleToStringStyleTest_Parameterized extends AbstractLangTest {
    ...
    public void testAppendSuper_1to2(String param1, String param2) {
        assertEquals(param1, new ToStringBuilder(base).appendSuper(param2).toString());
    }
    ...
    public void testAppendSuper_3to4(String param1, String param2, String param3, String param4) {
        assertEquals(param1, new ToStringBuilder(base).appendSuper(param4).append(param2, param3).toString());
    }

    static public Stream<Arguments> Provider_testAppendSuper_3to4() {
        return Stream.of(arguments("hello", "a", "hello", ""), arguments("<null>,hello", "a", "hello", "<null>"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testCollection_1to2")
    public void testCollection_1to2(String param1, String param2) {
        assertEquals(param1, new ToStringBuilder(base).append(param2, Collections.emptyList(), false).toString());
    }

    static public Stream<Arguments> Provider_testCollection_1to2() {
        return Stream.of(arguments("<size=0>", "a"), arguments("[]", "a"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testMap_1to2")
    public void testMap_1to2(String param1, String param2) {
        assertEquals(param1, new ToStringBuilder(base).append(param2, Collections.emptyMap(), false).toString());
    }
    ...
    public void testMap_3to4(String param1, String param2, String param3, String param4) {
        assertEquals(param1, new ToStringBuilder(base).append(param2, Collections.singletonMap(param4, "v"), param3).toString());
    }

    static public Stream<Arguments> Provider_testMap_3to4() {
        return Stream.of(arguments("<size=1>", "a", "k", "v"), arguments("{k=v}", "a", "k", "v"));
    }
}
