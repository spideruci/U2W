...
public class SentenceValidatorTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testIsValidWithInvalidInput_1_3to16")
    public void testIsValidWithInvalidInput_1_3to16(String param1) {
        assertFalse(SentenceValidator.isValid(param1));
    }

    static public Stream<Arguments> Provider_testIsValidWithInvalidInput_1_3to16() {
        return Stream.of(arguments("$ABCDE,1,2,3,4,5,6,7,8,9*00"), arguments(""), arguments("$"), arguments("*"), arguments("$,*"), arguments("$GPGSV*"), arguments("foobar"), arguments("$gpgga,1,2,3,4,5,6,7,8,9"), arguments("GPGGA,1,2,3,4,5,6,7,8,9"), arguments("$GpGGA,1,2,3,4,5,6,7,8,9"), arguments("$GPGGa,1,2,3,4,5,6,7,8,9"), arguments("$GPGG#,1,2,3,4,5,6,7,8,9"), arguments("$AB,1,2,3,4,5,6,7,8,9"), arguments("$ABCDEFGHIJK,1,2,3,4,5,6,7,8,9"), arguments("$GPGGA,1,2,3,4,5,6,7,8,9*00"));
    }

    @ParameterizedTest
    @MethodSource("Provider_testIsValidAIS_1to6")
    public void testIsValidAIS_1to6(String param1) {
        assertTrue(SentenceValidator.isValid(param1));
    }

    static public Stream<Arguments> Provider_testIsValidAIS_1to6() {
        return Stream.of(arguments("!AIVDM,1,1,,A,133sfv002POVWD0Je4sMA:a@00S?,0"), arguments("!AIVDM,1,1,,A,133sfv002POVWD0Je4sMA:a@00S?,0*3F"), arguments("!AIVDM,1,1,,A,13IWB67P00wdI9pKF>atlww>2@G4,0"), arguments("!AIVDM,1,1,,A,13IWB67P00wdI9pKF>atlww>2@G4,0*4F"), arguments("!AIVDM,1,1,,B,1CI7wSg000woG1rK3DMh0q3D00RV,0"), arguments("!AIVDM,1,1,,B,1CI7wSg000woG1rK3DMh0q3D00RV,0*6D"));
    }
}
