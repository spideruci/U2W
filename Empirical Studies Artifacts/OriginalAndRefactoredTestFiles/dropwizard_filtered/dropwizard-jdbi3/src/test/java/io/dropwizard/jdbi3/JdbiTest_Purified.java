...
class JdbiTest_Purified {
    ...
    @Test
    void canAcceptOptionalParams_2() {
    ...
    @Test
    void canAcceptEmptyOptionalParams_2() {
        assertThat(metricRegistry.timer("game-dao.findHomeTeamByGameId").getCount()).isEqualTo(1);
    }
    ...
    @Test
    void canReturnImmutableLists_2() {
    ...
    @Test
    void worksWithAbsentOptionalDates_2() {
        assertThat(metricRegistry.timer("game-dao.last-played-date").getCount()).isEqualTo(1);
    }
}
