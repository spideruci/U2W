...
public class OSMReaderTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testFixWayName_1to2")
    public void testFixWayName_1to2(String param1, String param2) {
        assertEquals(param1, OSMReader.fixWayName(param2));
    }

    static public Stream<Arguments> Provider_testFixWayName_1to2() {
        return Stream.of(arguments("B8, B12", "B8;B12"), arguments("B8, B12", "B8; B12"));
    }
}
