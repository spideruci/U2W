...
public class GpxConversionsTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testXMLEscape_issue572_1to3")
    public void testXMLEscape_issue572_1to3(String param1, String param2) {
        assertEquals(param1, GpxConversions.simpleXMLEscape(param2));
    }

    static public Stream<Arguments> Provider_testXMLEscape_issue572_1to3() {
        return Stream.of(arguments("_", "<"), arguments("_blup_", "<blup>"), arguments("a&amp;b", "a&b"));
    }
}
