...
public class AuthorizationCodeRequestTest_Purified extends AbstractAuthorizationTest<AuthorizationCodeCredentials> {

    private final AuthorizationCodeRequest defaultRequest = SPOTIFY_API.authorizationCode(AUTHORIZATION_CODE).setHttpManager(TestUtil.MockedHttpManager.returningJson("requests/authorization/authorization_code/AuthorizationCode.json")).grant_type("authorization_code").redirect_uri(SPOTIFY_API.getRedirectURI()).build();
