...
public class SitesImplTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_knownSiteKey_5to6")
    public void knownSiteKey_5to6(String param1, String param2, String param3) {
        assertEquals(this.sites.getPageUrl(param2, param3), param1);
    }

    static public Stream<Arguments> Provider_knownSiteKey_5to6() {
        return Stream.of(arguments("http://en.wikipedia.org/wiki/Page_name", "enwiki", "Page name"), arguments("http://example.org/page/Page+name", "somesite", "Page name"));
    }
}
