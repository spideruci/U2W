...
class KeyedSortPartitionOperatorTest_Purified {
    ...
    void testSortPartition_1() throws Exception {
        KeyedSortPartitionOperator<Tuple2<Integer, String>, String> operator1 = createSortPartitionOperatorWithPositionField();
    ...
    void testSortPartition_2() throws Exception {
        KeyedSortPartitionOperator<TestPojo, String> operator2 = createSortPartitionOperatorWithStringField();
    ...
    void testSortPartition_3() throws Exception {
        KeyedSortPartitionOperator<TestPojo, String> operator3 = createSortPartitionOperatorWithKeySelector();
