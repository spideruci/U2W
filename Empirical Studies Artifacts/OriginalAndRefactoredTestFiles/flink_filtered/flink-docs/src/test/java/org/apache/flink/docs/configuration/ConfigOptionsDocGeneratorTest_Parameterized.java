...
class ConfigOptionsDocGeneratorTest_Parameterized {
    ...
    @ParameterizedTest
    @MethodSource("Provider_testSnakeCaseConversion_1to3")
    void testSnakeCaseConversion_1to3(String param1, String param2) {
        assertThat(ConfigOptionsDocGenerator.toSnakeCase(param2)).isEqualTo(param1);
    }

    static public Stream<Arguments> Provider_testSnakeCaseConversion_1to3() {
        return Stream.of(arguments("rocks_options", "RocksOptions"), arguments("rocksdb_options", "RocksDBOptions"), arguments("db_options", "DBOptions"));
    }
}
